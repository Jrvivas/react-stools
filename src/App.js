...
import PageListPedido from './components/pedido/page_list_pedido'
import PageViewPedido from './components/pedido/page_view_pedido'
import PageEditPedido from './components/pedido/page_edit_pedido'

import PageListUser from './components/user/page_list_user'
import PageViewUser from './components/user/page_view_user'
import PageEditUser from './components/user/page_edit_user'

import PagePreciosCliente from './components/precio/page_precios_cliente'
...
import BarraNavApp from './components/barra_nav_app';
          ...
          <BarraNavApp></BarraNavApp>
           <Router>
                  <Switch>
                    ...
                    <Route exact path="/precio-cliente/:id"  children={<PrecioCliente/>}></Route>

                    <Route exact path="/pedido/">
                      <PageListPedido />
                    </Route>
                    <Route  path="/pedido/view/:id" children={<ViewPedido/>}></Route>
                    <Route path="/pedido/edit/:id" children={<EditPedido/>}></Route>
                    <Route path="/pedido/new" children={<NewPedido/>}></Route>
                    <Route path="/pedidoo/delete/:id" children={<DeletePedido/>}></Route>


                    <Route exact path="/user/">
                      <PageListUser />
                    </Route>
                    <Route  path="/user/view/:id" children={<ViewUser/>}></Route>
                    <Route path="/user/edit/:id" children={<EditUser/>}></Route>
                    <Route path="/user/new" children={<NewUser/>}></Route>
                    <Route path="/usero/delete/:id" children={<DeleteUser/>}></Route>
...
function PrecioCliente(){
  let {id}= useParams();
  return(
     <PagePreciosCliente idCliente={id}></PagePreciosCliente>
  )
} 
...
function EditPedido(){
  let { id } = useParams();
  return (
    <PageEditPedido idPedido={id}/>
  );
}
function NewPedido(){
 
  return (
    <PageEditPedido idPedido={''}/>
  );
}
